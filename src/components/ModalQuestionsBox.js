...
const ModalQuestionsBox = ({questions, categoryToDisplay}) => {
 const [open, setOpen] = useState(false)  
  return (
    <Modal
      ...
      onOpen={() => setOpen(true)}
      open={open}
      trigger={<Button className="ui blue button">Show Modal</Button>}
    >
      <Modal.Header>Questions Category: {categoryToDisplay}</Modal.Header>
      <Modal.Content image>
...
export default ModalQuestionsBox